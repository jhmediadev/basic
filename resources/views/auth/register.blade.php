                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="index.html" class="auth-logo">
                                <img src="{{asset('backend/assets/images/FT_logo.png')}}" height="80" class="logo-dark mx-auto" alt="">
                                <img src="{{asset('backend/assets/images/FT_logo.png')}}" height="80" class="logo-light mx-auto" alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control" id="password" type="password" name="password_confirmation" required="" placeholder="Password Confirmation">
                                </div>
                            </div>

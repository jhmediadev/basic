                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('store.profile')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="avatar-lg" src="{{ (!empty($editData->profile_image)) ? url('uploads/admin_images/'.$editData->profile_image) : url('uploads/smno_image.jpg') }}" alt="Card image cap">
                                </div>
                            </div>
